...
HD_PWD='D:/vivado Projects/Projet 4A/HorizonVHDL/VGA/VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Horizon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Horizon.tcl
