...
HD_PWD='D:/vivado Projects/Projet 4A/HorizonVHDL/VGA/VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Horizon.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Horizon.tcl -notrace
